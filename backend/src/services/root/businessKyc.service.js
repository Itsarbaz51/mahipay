  ...
  static async getAllBusinessKyc(currentUser, options = {}) {
    try {
      ...
      await AuditService.createLog({
        ...
        description: `Root user viewed all Business KYC applications. Filters: status=${status}, search=${search}`,
        status: "SUCCESS",
      });
      ...
      await AuditService.createLog({
        ...
        performedByType: currentUser.role,
        performedById: currentUser.id,
        description: "Root user failed to get Business KYC applications",
        status: "FAILED",
  ...
  static async getBusinessKycById(businessKycId, currentUser) {
    try {
      ...
      await AuditService.createLog({
        ...
        performedByType: currentUser.role,
        performedById: currentUser.id,
        description: `Root user viewed Business KYC details for: ${businessKyc.businessName}`,
        status: "SUCCESS",
      });
      ...
      await AuditService.createLog({
        ...
        performedByType: currentUser.role,
        performedById: currentUser.id,
        description: "Root user failed to get Business KYC details",
        status: "FAILED",
        errorMessage: error.message,
      });
...
export default RootBusinessKycService;
