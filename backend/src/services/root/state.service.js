// services/root/rootState.service.js
  ...
  static async getStateById(stateId, currentUser) {
    try {
      ...
      await AuditService.createLog({
        ...
        performedByType: currentUser.role,
        performedById: currentUser.id,
        description: `Root user viewed state details: ${state.stateName}`,
        status: "SUCCESS",
      });
      ...
      await AuditService.createLog({
        ...
        performedByType: currentUser.role,
        performedById: currentUser.id,
        description: "Root user failed to get state details",
        status: "FAILED",
        errorMessage: error.message,
      });
...
export default RootStateService;
